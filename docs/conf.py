# -*- coding: utf-8 -*-
#
# Burp-UI documentation build configuration file, created by
...
try:
    release = open('../burpui/RELEASE').read().rstrip() or version
except:
    release = version
...
latex_documents = [
  (master_doc, 'Burp-UI.tex', u'Burp-UI Documentation',
   u'Ziirish', 'manual'),
]
